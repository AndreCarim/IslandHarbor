	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float temp_output_18_0 = sin( mulTime8 );
				...
				float3 vertexValue = float3( ( ( _Scale * ( appendResult31 * temp_output_18_0 ) ) * tex2Dlod( _TextureSample0, float4( uv_TextureSample0, 0, 0.0) ).r ) ,  0.0 );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( _Emissive * ( IN.ase_color * tex2DNode1 ) ).rgb;
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-1119.025,212.9824;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;32;178.7604,481.4659;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;None;12c6c6bfe99ec1142a9f8f2dcfa6ffe5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
