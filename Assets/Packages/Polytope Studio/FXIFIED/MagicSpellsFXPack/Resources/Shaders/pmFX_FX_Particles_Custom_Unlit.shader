...
Shader "pmFX/FX/FX_Particles_Custom_Unlit"
{
	Properties
	{
		...
		[ASEEnd]_DepthDistance1("Depth Distance", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 saferPower20 = abs( ( ( _Emissive * ( _ParticleColor * tex2DNode1 ) ) * IN.ase_color ) );
				...
				float distanceDepth17 = saturate( abs( ( screenDepth17 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthDistance1 ) ) );
				float temp_output_19_0 = saturate( ( ( tex2DNode1.a * IN.ase_color.a * _ParticleColor.a ) * distanceDepth17 ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = saturate( ( pow( saferPower20 , temp_cast_0 ) * temp_output_19_0 ) ).rgb;
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.ColorNode;2;-427.9001,-186.6599;Inherit;False;Property;_ParticleColor;Particle Color;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;2,2,2,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-499.459,27.23388;Inherit;True;Property;_MainTex;Main Tex;1;0;Create;True;0;0;0;False;0;False;-1;None;a458e45d86768e8489ec7c3f55f53b4d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;4;-394.3995,259.9923;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-569.915,497.1248;Inherit;False;Property;_DepthDistance1;Depth Distance;6;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-178.9943,-229.8603;Inherit;False;Property;_Emissive;Emissive;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
WireConnection;44;3;19;0
WireConnection;20;0;6;0
WireConnection;20;1;21;0
ASEEND*/
//CHKSM=0831A210D01E9FED21400B909799C05FD0EC7DFD